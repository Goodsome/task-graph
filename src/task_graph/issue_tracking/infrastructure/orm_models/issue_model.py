...
class IssueModel(Base):
    ...
    type: Mapped[IssueType] = mapped_column(ENUM(IssueType, name='issue_type_enum'), nullable=False)
    severity: Mapped[Severity] = mapped_column(ENUM(Severity, name='issue_severity_enum'), nullable=False)
...
class IssueTaskLinkModel(Base):
    ...
    issue: Mapped["IssueModel"] = relationship("IssueModel", back_populates="task_links")
